    ...
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        ...
        <div className="flex space-x-6 mb-6">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out duration-150
        ...
        <div className="flex items-center mb-6">
            <div className="">
                ...
                <div className="flex w-full justify-center items-center space-x-6">
                    ...
                    {type === "rent" && (
                        <div className="">
                            <p className="text-md w-full whitespace-nowrap font-semibold">Rs. / Month</p>
                        </div>
                    )}
                </div>
            </div>
        ...
        <div className="mb-6">
            ...
            <p className="text-gray-600">The first image will be the cover (max-images: 6)</p>
